...
class StudyProgramSeeder extends Seeder
{
    ...
    {
        // ── 21 Subject IDs (SubjectSeeder SMAN 18 Garut) ──
        // 1=PAI, 2=PKN, 3=BIND, 4=MTK, 5=BING, 6=PJOK, 7=SEJ, 8=SBD, 9=MLOK, 10=INF
        // 11=MTKL, 12=PRAK, 13=FIS, 14=GEO, 15=BINGL, 16=EKO, 17=KIM, 18=BIO, 19=SOS, 20=IPA, 21=IPS
        //
        // ── 6 RIASEC Category IDs (InterestCategorySeeder) ──
        // 1=Realistic (R) 🔧
        // 2=Investigative (I) 🔬
        // 3=Artistic (A) 🎨
        // 4=Social (S) 🤝
        ...
        $programs = [
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 8, 'primary_weight' => 0.50, 'secondary_subject_id' => 12, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: Seni Budaya
            ],
            [
                'name' => 'Sejarah',
                ...
                'criteria' => ['primary_subject_id' => 7, 'primary_weight' => 0.50, 'secondary_subject_id' => 3, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: Sejarah
            ],
            [
                'name' => 'Linguistik',
                'faculty' => 'Fakultas Ilmu Budaya',
                ...
                'criteria' => ['primary_subject_id' => 3, 'primary_weight' => 0.50, 'secondary_subject_id' => 5, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: B. Indonesia Lanjut & B. Inggris
            ],
            [
                'name' => 'Susastra',
                'faculty' => 'Fakultas Ilmu Budaya',
                ...
                'criteria' => ['primary_subject_id' => 3, 'primary_weight' => 0.50, 'secondary_subject_id' => 15, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: B. Indonesia Lanjut & Bahasa Asing/B. Inggris Lanjut
            ],
            [
                'name' => 'Filsafat',
                ...
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 7, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: Sosiologi
            ],

            // ── 2. ILMU SOSIAL (No. 6 s/d 9) ──
            [
                'name' => 'Sosial',
                ...
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 7, 'secondary_weight' => 0.20, 'interest_category_id' => 4, 'interest_weight' => 0.30] // Mapel: Sosiologi
            ],
            [
                'name' => 'Ekonomi',
                ...
                'criteria' => ['primary_subject_id' => 16, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 5, 'interest_weight' => 0.30] // Mapel: Ekonomi dan/atau Matematika
            ],
            [
                'name' => 'Pertahanan',
                ...
                'criteria' => ['primary_subject_id' => 2, 'primary_weight' => 0.50, 'secondary_subject_id' => 19, 'secondary_weight' => 0.20, 'interest_category_id' => 5, 'interest_weight' => 0.30] // Mapel: Pendidikan Pancasila
            ],
            [
                'name' => 'Psikologi',
                ...
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 4, 'interest_weight' => 0.30] // Mapel: Sosiologi dan/atau Matematika
            ],

            // ── 3. ILMU ALAM (No. 10 s/d 16) ──
            [
                'name' => 'Kimia',
                ...
                'criteria' => ['primary_subject_id' => 17, 'primary_weight' => 0.50, 'secondary_subject_id' => 18, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Kimia
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 13, 'primary_weight' => 0.50, 'secondary_subject_id' => 11, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Fisika dan/atau Matematika Lanjut
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 17, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Biologi
            ],
            [
                'name' => 'Biologi',
                'faculty' => 'Fakultas Matematika dan Ilmu Pengetahuan Alam',
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 13, 'primary_weight' => 0.50, 'secondary_subject_id' => 18, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Fisika
            ],
            [
                'name' => 'Fisika',
                'faculty' => 'Fakultas Matematika dan Ilmu Pengetahuan Alam',
                ...
                'criteria' => ['primary_subject_id' => 13, 'primary_weight' => 0.50, 'secondary_subject_id' => 11, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Fisika
            ],
            [
                'name' => 'Astronomi',
                'faculty' => 'Fakultas Matematika dan Ilmu Pengetahuan Alam',
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 11, 'primary_weight' => 0.50, 'secondary_subject_id' => 10, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: Matematika Lanjut
            ],
            [
                'name' => 'Logika',
                'faculty' => 'Fakultas Matematika dan Ilmu Pengetahuan Alam',
                ...
                'criteria' => ['primary_subject_id' => 11, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Matematika Lanjut
            ],
            [
                'name' => 'Matematika',
                'faculty' => 'Fakultas Matematika dan Ilmu Pengetahuan Alam',
            ...
            // ── 5. ILMU TERAPAN (No. 20 s/d 59) ──
            [
                'name' => 'Ilmu dan Sains Pertanian',
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 17, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: Biologi
            ],
            [
                'name' => 'Peternakan',
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 4, 'primary_weight' => 0.50, 'secondary_subject_id' => 13, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: Matematika dan/atau Fisika
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 16, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: Ekonomi dan/atau Matematika
            ],
            [
                'name' => 'Desain',
                'faculty' => 'Fakultas Seni dan Desain',
                ...
                'criteria' => ['primary_subject_id' => 8, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: Seni Budaya dan/atau Matematika
            ],
            [
                ...
                'universities' => ['Universitas Indonesia (UI)', 'Universitas Gadjah Mada (UGM)', 'Universitas Padjadjaran (Unpad)', 'Universitas Diponegoro (Undip)', 'Universitas Brawijaya (UB)'],
                'criteria' => ['primary_subject_id' => 16, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 6, 'interest_weight' => 0.30] // Mapel: Ekonomi
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 16, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 5, 'interest_weight' => 0.30] // Mapel: Ekonomi
            ],
            [
                'name' => 'Logistik',
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 16, 'primary_weight' => 0.50, 'secondary_subject_id' => 19, 'secondary_weight' => 0.20, 'interest_category_id' => 6, 'interest_weight' => 0.30] // Mapel: Ekonomi
            ],
            [
                'name' => 'Bisnis',
                'faculty' => 'Fakultas Bisnis',
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 3, 'secondary_weight' => 0.20, 'interest_category_id' => 5, 'interest_weight' => 0.30] // Mapel: Sosiologi dan/atau Antropologi
            ],
            [
                'name' => 'Pendidikan',
                ...
                'criteria' => ['primary_subject_id' => 3, 'primary_weight' => 0.50, 'secondary_subject_id' => 19, 'secondary_weight' => 0.20, 'interest_category_id' => 4, 'interest_weight' => 0.30] // Mapel: Mapel yang relevan (B. Indonesia / Sosiologi)
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 13, 'primary_weight' => 0.50, 'secondary_subject_id' => 11, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: Fisika/Kimia dan/atau Matematika Lanjut
            ],
            [
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 17, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Biologi dan/atau Kimia
            ],
            [
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 17, 'primary_weight' => 0.50, 'secondary_subject_id' => 18, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Biologi dan/atau Kimia
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 17, 'secondary_weight' => 0.20, 'interest_category_id' => 4, 'interest_weight' => 0.30] // Mapel: Biologi dan/atau Kimia
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 19, 'secondary_weight' => 0.20, 'interest_category_id' => 4, 'interest_weight' => 0.30] // Mapel: Biologi
            ],
            [
                'name' => 'Kebidanan',
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 17, 'secondary_weight' => 0.20, 'interest_category_id' => 4, 'interest_weight' => 0.30] // Mapel: Biologi
            ],
            [
                'name' => 'Keperawatan',
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 11, 'primary_weight' => 0.50, 'secondary_subject_id' => 3, 'secondary_weight' => 0.20, 'interest_category_id' => 6, 'interest_weight' => 0.30] // Mapel: Matematika Lanjut
            ],
            [
                'name' => 'Hukum',
                ...
                'universities' => ['Universitas Indonesia (UI)', 'Universitas Gadjah Mada (UGM)', 'Universitas Padjadjaran (Unpad)', 'Universitas Diponegoro (Undip)', 'Universitas Airlangga (Unair)'],
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 2, 'secondary_weight' => 0.20, 'interest_category_id' => 5, 'interest_weight' => 0.30] // Mapel: Sosiologi dan/atau Pendidikan Pancasila
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 2, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: Sosiologi
            ],
            [
                'name' => 'Urusan Publik',
                'faculty' => 'Fakultas Ilmu Administrasi',
                ...
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 2, 'secondary_weight' => 0.20, 'interest_category_id' => 6, 'interest_weight' => 0.30] // Mapel: Sosiologi
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 6, 'primary_weight' => 0.50, 'secondary_subject_id' => 18, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: PJOK dan/atau Biologi
            ],
            [
                'name' => 'Pariwisata',
                ...
                'criteria' => ['primary_subject_id' => 16, 'primary_weight' => 0.50, 'secondary_subject_id' => 15, 'secondary_weight' => 0.20, 'interest_category_id' => 5, 'interest_weight' => 0.30] // Mapel: Ekonomi dan/atau B. Inggris Lanjut
            ],
            [
                'name' => 'Transportasi',
                'faculty' => 'Fakultas Teknik',
                ...
                'criteria' => ['primary_subject_id' => 11, 'primary_weight' => 0.50, 'secondary_subject_id' => 13, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: Matematika Lanjut
            ],
            [
                'name' => 'Bioteknologi',
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Biologi dan/atau Matematika
            ],
            [
                'name' => 'Geografi',
                'faculty' => 'Fakultas Matematika dan Ilmu Pengetahuan Alam',
                ...
                'criteria' => ['primary_subject_id' => 14, 'primary_weight' => 0.50, 'secondary_subject_id' => 4, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Geografi dan/atau Matematika
            ],
            [
                ...
                'criteria' => ['primary_subject_id' => 18, 'primary_weight' => 0.50, 'secondary_subject_id' => 11, 'secondary_weight' => 0.20, 'interest_category_id' => 6, 'interest_weight' => 0.30] // Mapel: Biologi dan/atau Matematika Lanjut
            ],
            [
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 17, 'primary_weight' => 0.50, 'secondary_subject_id' => 18, 'secondary_weight' => 0.20, 'interest_category_id' => 1, 'interest_weight' => 0.30] // Mapel: Kimia dan/atau Biologi
            ],
            [
                'name' => 'Sains Data',
                'faculty' => 'Fakultas Ilmu Komputer',
                ...
                'criteria' => ['primary_subject_id' => 11, 'primary_weight' => 0.50, 'secondary_subject_id' => 10, 'secondary_weight' => 0.20, 'interest_category_id' => 2, 'interest_weight' => 0.30] // Mapel: Matematika Lanjut
            ],
            [
            ...
            [
                ...
                'criteria' => ['primary_subject_id' => 19, 'primary_weight' => 0.50, 'secondary_subject_id' => 7, 'secondary_weight' => 0.20, 'interest_category_id' => 3, 'interest_weight' => 0.30] // Mapel: Antropologi dan/atau Sosiologi
            ],
        ];

        // Sinkronisasi data 59 program studi
